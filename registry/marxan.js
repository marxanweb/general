var CLIENT_VERSION = "v0.9.33";
var SERVER_VERSION = "v0.9.33";
...
var MARXAN_SERVERS = [{name: 'JRC Development Server', port: 8081, host: '61c92e42cb1042699911c485c38d52ae.vfs.cloud9.eu-west-1.amazonaws.com', protocol:'https:', description: 'Main development server for Marxan Web.',type:'remote'},
                      {name: 'Marxan Web Training Course', port: 443, host: 'training.marxanweb.org', protocol:'https:', description: 'Central service for running Marxan Web training courses',type:'remote',project:'marxan-web',zone:'us-central1-a',instanceName:'training-marxanweb-org'},
...
var WDPA = {latest_version:'March 2020',downloadUrl:'https://www.protectedplanet.net/downloads/WDPA_Mar2020?type=shapefile', tilesUrl:'https://geospatial.jrc.ec.europa.eu/geoserver/gwc/service/wmts?','metadataUrl':'https://www.protectedplanet.net/c/monthly-updates/2020/march-2020-update-of-the-wdpa',project:'geeImageServer',zone:'europe-west6-a',instanceName:'marxan-test-server'};
...
var NOTIFICATIONS = [
    ...
    {id:5, html:"<i>'Spatial action planning for biodiversity in 2020 and beyond'</i>. Marxan Web Training Session on 14/06/2020 at the World Conservation Congress in Marseille", type:"Training", expires: "14/06/2020", showForRoles: ["Admin","User","ReadOnly"]}
    ];
