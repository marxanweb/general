...
var MARXAN_SERVERS = [{name: 'JRC Development Server', port: 8081, host: '61c92e42cb1042699911c485c38d52ae.vfs.cloud9.eu-west-1.amazonaws.com', protocol:'https:', description: 'Main development server for Marxan Web.',type:'remote'},
                      {name: 'Marxan Web Training Course', port: 443, host: 'training.marxanweb.org', protocol:'https:', description: 'Central service for running Marxan Web training courses',type:'remote',client_id: '956491209288-m1fj9h3udhiviuj0hdvajrp8o7pn13g8.apps.googleusercontent.com',project:'marxan-web',zone:'us-central1-a',instanceName:'training-marxanweb-org'},
