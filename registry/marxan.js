...
var MARXAN_SERVERS = [{name: 'JRC Development Server', port: 8080, host: 'marxan-server-blishten.c9users.io', protocol:'https:', description: 'Main development server for Marxan Web.',type:'remote'},
                     ...
                     {name:'Beta test', port: 8080, host: 'andrewcottam.com',protocol:'https:', description:'Beta test Marxan Server hosted on Google Cloud Platform on port 8080. All projects will be deleted at the end.', type:'remote'}]
