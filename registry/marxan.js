...
var MARXAN_SERVERS = [{name: 'JRC Development Server', host: 'https://marxan-server-blishten.c9users.io:8080',description: 'Main development server for Marxan Web.',type:'remote'},
                     ...
                     {name:'Beta test',host: 'https://andrewcottam.com:8080',description:'Beta test Marxan Server hosted on Google Cloud Platform on port 8080. All projects will be deleted at the end.', type:'remote'}]
