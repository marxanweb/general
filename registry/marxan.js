...
var MARXAN_SERVERS = [{name: 'JRC Development Server', port: 8081, host: '61c92e42cb1042699911c485c38d52ae.vfs.cloud9.eu-west-1.amazonaws.com', protocol:'https:', description: 'Main development server for Marxan Web.',type:'remote'},
                     ...
                     {name:'Beta test', port: 443, host: 'andrewcottam.com',protocol:'https:', description:'Marxan Server specifically for training hosted on Google Cloud Platform. All projects will be deleted at the end.', type:'remote',project:'geeImageServer',zone:'europe-west6-a',instanceName:'marxan-test-server'}];
