...
var MARXAN_SERVERS = [{ name: 'JRC Development Server', port: 8081, host: '61c92e42cb1042699911c485c38d52ae.vfs.cloud9.eu-west-1.amazonaws.com', protocol: 'https:', description: 'Main development server for Marxan Web.', type: 'remote' },
    { name: 'Marxan Web Training Course', port: 8080, host: 'marxantraining.org', protocol: 'https:', description: 'Central service for running Marxan Web training courses', type: 'remote', project: 'marxan-web', zone: 'us-central1-a', instanceName: 'marxantraining-org' },
