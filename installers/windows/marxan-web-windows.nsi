...
;General
  ...
  ;Name and file
  Name "Marxan Web"
  OutFile "marxan-web-v0.9.34.exe" ;TODO Update to correct version
...
Section "Marxan Server" SectionMarxanServer
  ...
  #create a runlog.dat file so we can git reset --hard without overwriting any changes to the runlog file
  File /oname=$INSTDIR\marxan-server\runlog.dat ..\..\..\marxan-server\runlog.dat.default
...
Section "Uninstall"
  ...
  ;change output directory so we can delete the marxanweb folder
